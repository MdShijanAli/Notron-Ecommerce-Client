<template>
  <BreadCrumbSection pageTitle="Privacy Policy"></BreadCrumbSection>
  <div>
    <div class="max-w-7xl mx-auto px-6 py-20">

 
    <div class="border p-10 shadow-xl text-justify">
...
<li>
<p>By visiting this page on our website: <a href="https://my-portfolio-md-shijan-ali.netlify.app/" rel="external nofollow noopener" target="_blank">https://my-portfolio-md-shijan-ali.netlify.app/</a></p>
</li>
<li>
